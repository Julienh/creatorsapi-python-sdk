...
from creatorsapi_python_sdk.models.item_id_type import ItemIdType
from creatorsapi_python_sdk.models.merchant import Merchant
...
class GetItemsRequestContent(BaseModel):
    ...
    additional_offers: Optional[StrictBool] = Field(default=None, description="Whether to retrieve additional offers outside the featured winners", alias="additionalOffers")
    ...
    item_id_type: Optional[ItemIdType] = Field(default=None, alias="itemIdType")
    ...
    __properties: ClassVar[List[str]] = ["partnerTag", "itemIds", "additionalOffers", "condition", "currencyOfPreference", "itemIdType", "languagesOfPreference", "merchant", "resources"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalOffers": obj.get("additionalOffers"),
            "condition": obj.get("condition"),
            "currencyOfPreference": obj.get("currencyOfPreference"),
            "itemIdType": obj.get("itemIdType"),

...
class SearchItemsRequestContent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["actor", "artist", "author", "availability", "brand", "browseNodeId", "condition", "currencyOfPreference", "deliveryFlags", "itemCount", "itemPage", "keywords", "languagesOfPreference", "maxPrice", "merchant", "minPrice", "minReviewsRating", "minSavingPercent", "partnerTag", "resources", "searchIndex", "sortBy", "title"]
